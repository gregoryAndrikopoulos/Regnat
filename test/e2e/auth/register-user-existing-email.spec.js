...
import { TEST_USER_NAME, TEST_USER_EMAIL_3 } from '../../../support/utils/testConstants.js';
...
describe('Test Case 5: Register User with existing email', function () {
  it('should show error when trying to sign up with an already registered email', async function () {
    ...
    await expect(SignupLoginPage.signupEmailExistsError).toHaveText('Email Address already exist!');
  });
});
