...
class ProductDetailsPage {
  ...
  get title() { return $('.product-information h2'); }
  get price() { return $('.product-information span > span'); }
  ...
  async assertOnDetailsPage() {
    ...
    await browser.waitUntil(
      ...
      { timeout: SHORT_TIMEOUT, timeoutMsg: 'URL did not include /product_details' }
    );
  }
